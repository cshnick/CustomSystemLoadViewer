...
Item {
    ...
    readonly property int borderRounding: 1
    ...
    Layout.preferredWidth: {
        if (circularMonitorsInUse) {
            return parent.height /** 1.2 */* 0.7 * columnCount()
        }
        ...
        var wantedWidth = 0//cpusRow.minWidth
    ...
    RowLayout {
        ...
        ColumnLayout {
            id: memColumn
            property double minWidth: units.gridUnit * 0.5
